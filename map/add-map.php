...
?>
    ...
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyCr-rOB_VDpw5mQLI8xIN-puFWkTw83rNw">
    </script>
    ...
    <script>
        ...
        for (i = 0; i < locations.length; i++) {
            marker = new google.maps.Marker({
                ...
                map: map,
                icon :   locations[i][4] === '1' ?  purple_icon  : red_icon,
                html: "<div>\n" +
                "<table class=\"map1\">\n" +
                "<tr>\n" +
                "<td><a>Description:</a></td>\n" +
        ...
        function saveData(lat,lng) {
            ...
            downloadUrl(url, function(data, responseCode) {
                if (responseCode === 200  && data.length > 1) {
                    ...
                    infowindow.close();
                    infowindow.setContent("<div style=' color: red; font-size: 25px;'> Added</div>");
